...
public class ListaEnlazadaSimple<T> implements Lista<T>, Iterable<T> {
    @Override
    public Iterator<T> iterator() {
        return new ListaIterador();
    }

    public class ListaIterador implements Iterator<T> {
